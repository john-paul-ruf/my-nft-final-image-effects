...
import {AmaroConfig} from './AmaroConfig.js';
import {Range} from 'my-nft-gen/src/core/layer/configType/Range.js';
import {DynamicRange} from 'my-nft-gen/src/core/layer/configType/DynamicRange.js';

export class AmaroEffect extends InstagramFilterEffect {
    static _name_ = 'instagram-amaro';
    static configClass = AmaroConfig;

    static presets = [
        {
            name: 'subtle-amaro',
            effect: 'instagram-amaro',
            percentChance: 100,
            currentEffectConfig: {
        ...
        },
        {
            ...
            currentEffectConfig: {
                ...
                contrastRange: new DynamicRange(new Range(1.15, 1.2), new Range(1.25, 1.3)),
                contrastTimes: new Range(2, 6),
                brightnessRange: new DynamicRange(new Range(1.25, 1.3), new Range(1.35, 1.45)),
    ...
    constructor({
                    name = AmaroEffect._name_,
                    requiresLayer = true,
                    config = new AmaroConfig({}),
                    additionalEffects = [],
